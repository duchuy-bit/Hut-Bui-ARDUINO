...
const int LeftMotorForward = 13; // banh ben trai tien 13
const int LeftMotorBackward = 12; // banh ben trai lui 12
const int RightMotorForward = 11; // banh ben phai tien 11
const int RightMotorBackward = 10; // banh ben phai lui 10
